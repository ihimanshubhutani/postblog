...
import { k as image } from "../icons-2651a870.js";
  ...
  return React.createElement(
    StyleWrapper,
    {
      ...
      className: "graf graf--figure "
        ...
        .concat(props.selected ? "is-selected is-mediaFocused" : ""),
    },
    React.createElement(
      "div",
      {
      ...
      React.createElement("div", {
        ...
        style: { paddingBottom: "".concat(ratio, "%") },
      }),
      React.createElement(ReactMediumZoom, {
        src: imageUrl,
        height: width,
        width: height,
        className: "graf-image ".concat(
          props.editor.isEditable ? ".no-zoom" : ""
        ),
...
function ImageRenderer(_a) {
  ...
  return React.createElement(
    "figure",
    { key: blockKey, className: "graf graf--figure ".concat(defaultAlignment) },
    React.createElement(
      "div",
      null,
      React.createElement(
        "div",
        { className: "aspectRatioPlaceholder is-locked", style: defaultStyle },
        React.createElement("div", {
          className: "aspect-ratio-fill",
          style: { paddingBottom: "".concat(ratio, "%") },
        }),
